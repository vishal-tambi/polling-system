    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-4">
            ...
            <button
                ...
                disabled={!name.trim()}
                className="bg-gradient-to-r from-[#8F64E1] to-[#1D68BD] text-white px-12 py-3 rounded-full font-medium disabled:opacity-40 hover:opacity-90 transition-opacity cursor-pointer"
            >
                Continue
            </button>
        </div>
